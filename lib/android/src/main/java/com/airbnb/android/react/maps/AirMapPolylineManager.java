...
public class AirMapPolylineManager extends ViewGroupManager<AirMapPolyline> {
  ...
  @ReactProp(name = "showBezierCurve", defaultBoolean = false)
  public void showBezierCurve(AirMapPolyline view, boolean showBezierCurve) {
    view.setShowBezierCurve(showBezierCurve);
  }
